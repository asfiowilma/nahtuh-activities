const HostPanel = new (function () {
  ...
  this.changeQuestion = (idx) => {
    ...
    oldCard.replaceClass("from-blue-200 to-blue-300 scale-105", "from-gray-200 to-gray-200");
    newCard.replaceClass("from-gray-200 to-gray-200", "from-blue-200 to-blue-300 scale-105");
  ...
  this.questionInput = () => {
    ...
    $("#dropzones").attr("x-data", `imageViewer('${loadedImage}')`);
